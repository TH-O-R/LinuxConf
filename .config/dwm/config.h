...
static const char *fonts[] = {"JetBrainsMono Nerd Font Mono:size=11.5"};
...
static const char col_MyBlue[] = "#6722F9";
...
static const char *colors[][3] = {
    ...
    [SchemeSel] = {col_gray4, col_MyBlue, col_MyBlue},
};
...
static Key keys[] = {
    ...
    {0,                             XK_F6,     spawn,          SHCMD("brightnessctl s 5%-" )},
    {0,                             XK_F7,     spawn,          SHCMD("brightnessctl s +5%" )},
    {MODKEY,                        XK_b,      togglebar,      {0}},
    {MODKEY|ControlMask,            XK_j,      swaptop,        {0} },
    {MODKEY|ControlMask,            XK_k,      swapdown,       {0} },

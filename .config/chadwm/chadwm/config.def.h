...
static const Key keys[] = {
    ...
    {MODKEY, XK_x, spawn, SHCMD("wlogout")},
    ...
    //&layouts[0]} }, { MODKEY|ShiftMask,                 XK_f,       setlayout,
    //{.v = &layouts[1]} }, { MODKEY,                           XK_m, setlayout,
    //{.v = &layouts[2]} }, { MODKEY|ControlMask,               XK_g, setlayout,
    //{.v = &layouts[10]} }, { MODKEY|ControlMask|ShiftMask,     XK_t,
    //setlayout,      {.v = &layouts[13]} }, { MODKEY, XK_space,   setlayout,
    //{0} },
